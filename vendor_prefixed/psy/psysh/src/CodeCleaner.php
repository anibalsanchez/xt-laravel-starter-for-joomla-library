...
use Extly\PhpParser\Parser;
use Extly\PhpParser\PrettyPrinter\Standard as Printer;
use Extly\Psy\CodeCleaner\AbstractClassPass;
use Extly\Psy\CodeCleaner\AssignThisVariablePass;
use Extly\Psy\CodeCleaner\CalledClassPass;
use Extly\Psy\CodeCleaner\CallTimePassByReferencePass;
use Extly\Psy\CodeCleaner\EmptyArrayDimFetchPass;
use Extly\Psy\CodeCleaner\ExitPass;
use Extly\Psy\CodeCleaner\FinalClassPass;
use Extly\Psy\CodeCleaner\FunctionContextPass;
use Extly\Psy\CodeCleaner\FunctionReturnInWriteContextPass;
use Extly\Psy\CodeCleaner\ImplicitReturnPass;
use Extly\Psy\CodeCleaner\InstanceOfPass;
use Extly\Psy\CodeCleaner\IssetPass;
use Extly\Psy\CodeCleaner\LabelContextPass;
use Extly\Psy\CodeCleaner\LeavePsyshAlonePass;
use Extly\Psy\CodeCleaner\ListPass;
use Extly\Psy\CodeCleaner\LoopContextPass;
use Extly\Psy\CodeCleaner\MagicConstantsPass;
use Extly\Psy\CodeCleaner\NamespacePass;
use Extly\Psy\CodeCleaner\PassableByReferencePass;
use Extly\Psy\CodeCleaner\RequirePass;
use Extly\Psy\CodeCleaner\ReturnTypePass;
use Extly\Psy\CodeCleaner\StrictTypesPass;
use Extly\Psy\CodeCleaner\UseStatementPass;
use Extly\Psy\CodeCleaner\ValidClassNamePass;
use Extly\Psy\CodeCleaner\ValidConstantPass;
use Extly\Psy\CodeCleaner\ValidConstructorPass;
use Extly\Psy\CodeCleaner\ValidFunctionNamePass;
...
class CodeCleaner
{
    ...
    private static function isDebugCall(array $stackFrame)
    {
        ...
        return ($class === null && $function === 'Extly\\Psy\\debug') ||
    ...
    private function parseErrorIsEOF(\Extly\PhpParser\Error $e)
    {
        $msg = $e->getRawMessage();
     ...
     * @return bool
     */
    private function parseErrorIsUnclosedString(\Extly\PhpParser\Error $e, $code)
    {
    ...
    private function parseErrorIsUnterminatedComment(\Extly\PhpParser\Error $e, $code)
    {
        return $e->getRawMessage() === 'Unterminated comment';
    }

    private function parseErrorIsTrailingComma(\Extly\PhpParser\Error $e, $code)
    {
