...
use Extly\Psy\Exception\Exception as PsyException;
use Extly\Psy\Exception\ThrowUpException;
use Extly\Psy\Exception\TypeErrorException;
use Extly\Psy\ExecutionLoop\ProcessForker;
use Extly\Psy\ExecutionLoop\RunkitReloader;
use Extly\Psy\Formatter\TraceFormatter;
use Extly\Psy\Input\ShellInput;
use Extly\Psy\Input\SilentInput;
use Extly\Psy\TabCompletion\Matcher;
use Extly\Psy\VarDumper\PresenterAware;
use Extly\Symfony\Component\Console\Application;
use Extly\Symfony\Component\Console\Command\Command as BaseCommand;
...
use Extly\Symfony\Component\Console\Input\StringInput;
...
class Shell extends Application
{
    ...
    {
        return \Extly\Psy\debug($vars, $bindTo);
    }
