...
use Extly\Egulias\EmailValidator\Exception\LocalOrReservedDomain;
use Extly\Egulias\EmailValidator\Exception\DomainAcceptsNoMail;
use Extly\Egulias\EmailValidator\Warning\NoDNSMXRecord;
use Extly\Egulias\EmailValidator\Exception\NoDNSRecord;
