...
use Extly\Symfony\Component\Config\Builder\ConfigBuilderGenerator;
...
abstract class Kernel implements KernelInterface, RebootableInterface, TerminableInterface
{
    ...
    protected function buildContainer()
    {
        ...
        if (null !== $cont = $this->registerContainerConfiguration($this->getContainerLoader($container))) {
            XT_trigger_deprecation('symfony/http-kernel', '5.3', 'Returning a ContainerBuilder from "%s::registerContainerConfiguration()" is deprecated.', get_debug_type($this));
