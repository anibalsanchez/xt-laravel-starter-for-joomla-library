...
namespace Extly\Symfony\Component\HttpKernel;

use Extly\Symfony\Bridge\ProxyManager\LazyProxy\Instantiator\RuntimeInstantiator;
use Extly\Symfony\Bridge\ProxyManager\LazyProxy\PhpDumper\ProxyDumper;
use Extly\Symfony\Component\Config\ConfigCache;
use Extly\Symfony\Component\Config\Loader\DelegatingLoader;
use Extly\Symfony\Component\Config\Loader\LoaderResolver;
use Extly\Symfony\Component\Debug\DebugClassLoader as LegacyDebugClassLoader;
use Extly\Symfony\Component\DependencyInjection\Compiler\CompilerPassInterface;
use Extly\Symfony\Component\DependencyInjection\Compiler\PassConfig;
...
use Extly\Symfony\Component\DependencyInjection\Dumper\PhpDumper;
use Extly\Symfony\Component\DependencyInjection\Dumper\Preloader;
use Extly\Symfony\Component\DependencyInjection\Extension\ExtensionInterface;
use Extly\Symfony\Component\DependencyInjection\Loader\ClosureLoader;
use Extly\Symfony\Component\DependencyInjection\Loader\DirectoryLoader;
use Extly\Symfony\Component\DependencyInjection\Loader\GlobFileLoader;
use Extly\Symfony\Component\DependencyInjection\Loader\IniFileLoader;
use Extly\Symfony\Component\DependencyInjection\Loader\PhpFileLoader;
use Extly\Symfony\Component\DependencyInjection\Loader\XmlFileLoader;
use Extly\Symfony\Component\DependencyInjection\Loader\YamlFileLoader;
use Extly\Symfony\Component\ErrorHandler\DebugClassLoader;
use Extly\Symfony\Component\Filesystem\Filesystem;
use Extly\Symfony\Component\HttpFoundation\Request;
use Extly\Symfony\Component\HttpFoundation\Response;
use Extly\Symfony\Component\HttpKernel\Bundle\BundleInterface;
use Extly\Symfony\Component\HttpKernel\CacheWarmer\WarmableInterface;
use Extly\Symfony\Component\HttpKernel\Config\FileLocator;
use Extly\Symfony\Component\HttpKernel\DependencyInjection\AddAnnotatedClassesToCachePass;
use Extly\Symfony\Component\HttpKernel\DependencyInjection\MergeExtensionConfigurationPass;
...
abstract class Kernel implements KernelInterface, RebootableInterface, TerminableInterface
{
        ...
        if ($collectDeprecations = $this->debug && !\defined('PHPUNIT_COMPOSER_INSTALL')) {
            ...
            $previousHandler = set_error_handler(function ($type, $message, $file, $line) use (&$collectedLogs, &$previousHandler) {
                ...
                for ($i = 0; isset($backtrace[$i]); ++$i) {
                    ...
                    if (!isset($backtrace[$i]['class']) && 'XT_trigger_deprecation' === $backtrace[$i]['function']) {
    ...
    protected function getContainerBuilder()
    {
        ...
        if (class_exists('ProxyManager\Configuration') && class_exists('Extly\Symfony\Bridge\ProxyManager\LazyProxy\Instantiator\RuntimeInstantiator')) {
    ...
    protected function dumpContainer(ConfigCache $cache, ContainerBuilder $container, string $class, string $baseClass)
    {
        ...
        if (class_exists('ProxyManager\Configuration') && class_exists('Extly\Symfony\Bridge\ProxyManager\LazyProxy\PhpDumper\ProxyDumper')) {
