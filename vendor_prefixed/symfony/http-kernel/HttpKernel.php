...
use Extly\Symfony\Component\HttpFoundation\Exception\RequestExceptionInterface;
...
use Extly\Symfony\Component\HttpKernel\Controller\ArgumentResolver;
use Extly\Symfony\Component\HttpKernel\Controller\ArgumentResolverInterface;
use Extly\Symfony\Component\HttpKernel\Controller\ControllerResolverInterface;
use Extly\Symfony\Component\HttpKernel\Event\ControllerArgumentsEvent;
use Extly\Symfony\Component\HttpKernel\Event\ControllerEvent;
use Extly\Symfony\Component\HttpKernel\Event\ExceptionEvent;
use Extly\Symfony\Component\HttpKernel\Event\FinishRequestEvent;
use Extly\Symfony\Component\HttpKernel\Event\RequestEvent;
use Extly\Symfony\Component\HttpKernel\Event\ResponseEvent;
use Extly\Symfony\Component\HttpKernel\Event\TerminateEvent;
use Extly\Symfony\Component\HttpKernel\Event\ViewEvent;
use Extly\Symfony\Component\HttpKernel\Exception\BadRequestHttpException;
use Extly\Symfony\Component\HttpKernel\Exception\ControllerDoesNotReturnResponseException;
    ...
    private function handleRaw(Request $request, int $type = self::MAIN_REQUEST): Response
    {
        ...
        if (!$response instanceof Response) {
            ...
            if ($event->hasResponse()) {
                ...
                $msg = sprintf('The controller must return a "Extly\Symfony\Component\HttpFoundation\Response" object but it returned %s.', $this->varToString($response));
