...
namespace Extly\Symfony\Component\String\Slugger;

use Extly\Symfony\Component\String\AbstractUnicodeString;
use Extly\Symfony\Component\String\UnicodeString;
use Extly\Symfony\Contracts\Translation\LocaleAwareInterface;

if (!interface_exists(LocaleAwareInterface::class)) {
    throw new \LogicException('You cannot use the "Extly\Symfony\Component\String\Slugger\AsciiSlugger" as the "symfony/translation-contracts" package is not installed. Try running "composer require symfony/translation-contracts".');
}
