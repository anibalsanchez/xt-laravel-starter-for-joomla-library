...
class DebugClassLoader
{
    ...
    public static function enable(): void
    {
        ...
        class_exists('Extly\Symfony\Component\ErrorHandler\ErrorHandler');
    ...
    {
        if (
            'Extly\Symfony\Bridge\PhpUnit\Legacy\SymfonyTestsListenerForV7' === $class
            || 'Extly\Symfony\Bridge\PhpUnit\Legacy\SymfonyTestsListenerForV6' === $class
        ) {
            return [];
        }
        $deprecations = [];
