...
use Extly\Symfony\Component\Config\Exception\LoaderLoadException;
use Extly\Symfony\Component\Config\Loader\LoaderInterface;
use Extly\Symfony\Component\Config\Resource\ResourceInterface;
use Extly\Symfony\Component\Routing\Loader\Configurator\RoutingConfigurator;

XT_trigger_deprecation('symfony/routing', '5.1', 'The "%s" class is deprecated, use "%s" instead.', RouteCollectionBuilder::class, RoutingConfigurator::class);
