...
use Extly\Symfony\Component\ExpressionLanguage\ExpressionLanguage;
...
use Extly\Symfony\Component\Routing\Route;
...
class UrlMatcher implements UrlMatcherInterface, RequestMatcherInterface
{
    ...
    protected function getExpressionLanguage()
    {
        if (null === $this->expressionLanguage) {
            if (!class_exists('Extly\Symfony\Component\ExpressionLanguage\ExpressionLanguage')) {
    ...
    {
        if (!class_exists('Extly\Symfony\Component\HttpFoundation\Request')) {
            return null;
        }
