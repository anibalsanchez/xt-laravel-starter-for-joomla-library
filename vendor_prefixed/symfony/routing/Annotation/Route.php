...
namespace Extly\Symfony\Component\Routing\Annotation;
...
class Route
{
    ...
    public function __construct(
        ...
        if (\is_string($data)) {
            ...
            if ($deprecation) {
                XT_trigger_deprecation('symfony/routing', '5.3', 'Passing an array as first argument to "%s" is deprecated. Use named arguments instead.', __METHOD__);
            } else {
                $localizedPaths = $data;
