...
use Extly\Carbon\Exceptions\ImmutableException;
...
interface CarbonInterface extends DateTimeInterface, JsonSerializable
{
     ...
     * @return $this
     */
    public function setLocalTranslator(\Extly\Symfony\Component\Translation\TranslatorInterface $translator);
     ...
     * @return void
     */
    public static function setTranslator(\Extly\Symfony\Component\Translation\TranslatorInterface $translator);
     ...
     * @return string
     */
    public function translate(string $key, array $parameters = [], $number = null, ?\Extly\Symfony\Component\Translation\TranslatorInterface $translator = null, bool $altNumbers = false): string;
     ...
     * @return string
     */
    public static function translateWith(\Extly\Symfony\Component\Translation\TranslatorInterface $translator, string $key, array $parameters = [], $number = null): string;
