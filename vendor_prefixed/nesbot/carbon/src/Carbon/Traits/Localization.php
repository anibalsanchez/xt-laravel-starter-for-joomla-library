 ...
 */
namespace Extly\Carbon\Traits;

use Extly\Carbon\CarbonInterface;
use Extly\Carbon\Exceptions\InvalidTypeException;
use Extly\Carbon\Exceptions\NotLocaleAwareException;
use Extly\Carbon\Language;
use Extly\Carbon\Translator;
use Closure;
use Extly\Symfony\Component\Translation\TranslatorBagInterface;
use Extly\Symfony\Component\Translation\TranslatorInterface;
use Extly\Symfony\Contracts\Translation\LocaleAwareInterface;
use Extly\Symfony\Contracts\Translation\TranslatorInterface as ContractsTranslatorInterface;

if (!interface_exists('Extly\\Symfony\\Component\\Translation\\TranslatorInterface')) {
    class_alias(
        'Extly\\Symfony\\Contracts\\Translation\\TranslatorInterface',
        'Extly\\Symfony\\Component\\Translation\\TranslatorInterface'
    );
}
