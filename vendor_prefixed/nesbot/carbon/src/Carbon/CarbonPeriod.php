...
use Extly\Carbon\Exceptions\InvalidCastException;
use Extly\Carbon\Exceptions\InvalidIntervalException;
use Extly\Carbon\Exceptions\InvalidPeriodDateException;
use Extly\Carbon\Exceptions\InvalidPeriodParameterException;
use Extly\Carbon\Exceptions\NotACarbonClassException;
use Extly\Carbon\Exceptions\NotAPeriodException;
use Extly\Carbon\Exceptions\UnknownGetterException;
use Extly\Carbon\Exceptions\UnknownMethodException;
use Extly\Carbon\Exceptions\UnreachableException;
use Extly\Carbon\Traits\IntervalRounding;
use Extly\Carbon\Traits\Mixin;
use Extly\Carbon\Traits\Options;
use Closure;
use Countable;
use DateInterval;
use DatePeriod;
...
class CarbonPeriod implements Iterator, Countable, JsonSerializable
{
     ...
     * @var string
     */
    const RECURRENCES_FILTER = 'Extly\Carbon\CarbonPeriod::filterRecurrences';
    const END_DATE_FILTER = 'Extly\Carbon\CarbonPeriod::filterEndDate';
     ...
     * @var string
     */
    const END_ITERATION = 'Extly\Carbon\CarbonPeriod::endIteration';
