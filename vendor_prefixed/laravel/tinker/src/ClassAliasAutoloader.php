...
namespace Extly\Laravel\Tinker;
...
class ClassAliasAutoloader
{
    ...
    {
        return XT_tap(new static($shell, $classMapPath, $includedAliases, $excludedAliases), function ($loader) {
    ...
    public function __construct(Shell $shell, $classMapPath, array $includedAliases = [], array $excludedAliases = [])
    {
        ...
        $this->includedAliases = XT_collect($includedAliases);
        $this->excludedAliases = XT_collect($excludedAliases);
