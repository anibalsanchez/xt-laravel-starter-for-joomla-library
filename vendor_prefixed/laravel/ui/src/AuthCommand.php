...
class AuthCommand extends Command
{
    ...
    protected function exportBackend()
    {
        ...
        $controller = XT_app_path('Http/Controllers/HomeController.php');
        ...
        copy(
            ...
            XT_base_path('database/migrations/2014_10_12_100000_create_password_resets_table.php')
        );
    }
    ...
    protected function getViewPath($path)
    {
        return implode(DIRECTORY_SEPARATOR, [
            XT_config('view.paths')[0] ?? XT_resource_path('views'), $path,
        ]);
    }
}
