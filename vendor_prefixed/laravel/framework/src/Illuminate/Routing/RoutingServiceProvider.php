...
use Extly\Illuminate\Contracts\Routing\ResponseFactory as ResponseFactoryContract;
use Extly\Illuminate\Contracts\Routing\UrlGenerator as UrlGeneratorContract;
use Extly\Illuminate\Contracts\View\Factory as ViewFactoryContract;
use Extly\Illuminate\Routing\Contracts\ControllerDispatcher as ControllerDispatcherContract;
...
class RoutingServiceProvider extends ServiceProvider
{
        ...
        $this->app->singleton('url', function ($app) {
            ...
            return new UrlGenerator(
                $routes, $app->rebinding(
                    'XT_request', $this->requestRebinder()
    ...
    {
        $this->app->singleton('XT_redirect', function ($app) {
        ...
        $this->app->bind(ServerRequestInterface::class, function ($app) {
            if (class_exists(Psr17Factory::class) && class_exists(PsrHttpFactory::class)) {
                ...
                return (new PsrHttpFactory($psr17Factory, $psr17Factory, $psr17Factory, $psr17Factory))
                    ->createRequest($app->make('XT_request'));
            }
    ...
    protected function registerResponseFactory()
    {
        $this->app->singleton(ResponseFactoryContract::class, function ($app) {
            return new ResponseFactory($app[ViewFactoryContract::class], $app['XT_redirect']);
        });
    }
