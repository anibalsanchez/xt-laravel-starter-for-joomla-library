...
use Extly\Illuminate\Routing\Matching\HostValidator;
use Extly\Illuminate\Routing\Matching\MethodValidator;
use Extly\Illuminate\Routing\Matching\SchemeValidator;
use Extly\Illuminate\Routing\Matching\UriValidator;
...
class Route
{
    ...
    protected function parseUri($uri)
    {
        ...
        return XT_tap(RouteUri::parse($uri), function ($uri) {
    ...
    {
        $groupStack = XT_last($this->router->getGroupStack());
