...
use Closure;
use Extly\Illuminate\Contracts\Encryption\DecryptException;
...
use Extly\Illuminate\Cookie\Middleware\EncryptCookies;
...
class VerifyCsrfToken
{
    ...
    public function handle($request, Closure $next)
    {
        if (
            ...
            return XT_tap($next($request), function ($response) use ($request) {
