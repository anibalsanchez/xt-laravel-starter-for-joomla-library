...
use Extly\Illuminate\Contracts\Validation\Validator;
use Extly\Illuminate\Http\Request;
use Extly\Illuminate\Routing\Redirector;
use Extly\Illuminate\Validation\ValidatesWhenResolvedTrait;
...
class FormRequest extends Request implements ValidatesWhenResolved
{
    ...
    protected function getValidatorInstance()
    {
        ...
        if (method_exists($this, 'XT_validator')) {
            $validator = $this->container->call([$this, 'XT_validator'], compact('factory'));
        } else {
