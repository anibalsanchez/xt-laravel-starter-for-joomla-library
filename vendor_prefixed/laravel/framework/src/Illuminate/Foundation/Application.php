...
use Extly\Illuminate\Contracts\Foundation\Application as ApplicationContract;
use Extly\Illuminate\Contracts\Foundation\CachesConfiguration;
use Extly\Illuminate\Contracts\Foundation\CachesRoutes;
use Extly\Illuminate\Contracts\Http\Kernel as HttpKernelContract;
use Extly\Illuminate\Events\EventServiceProvider;
use Extly\Illuminate\Filesystem\Filesystem;
use Extly\Illuminate\Foundation\Bootstrap\LoadEnvironmentVariables;
use Extly\Illuminate\Foundation\Events\LocaleUpdated;
use Extly\Illuminate\Http\Request;
use Extly\Illuminate\Log\LogServiceProvider;
use Extly\Illuminate\Routing\RoutingServiceProvider;
...
class Application extends Container implements ApplicationContract, CachesConfiguration, CachesRoutes, HttpKernelInterface
{
    ...
    public function registerCoreContainerAliases()
    {
        foreach ([
            ...
            'encrypter'            => [\Extly\Illuminate\Encryption\Encrypter::class, \Extly\Illuminate\Contracts\Encryption\Encrypter::class],
    ...
    public function getNamespace()
    {
        ...
        foreach ((array) XT_data_get($composer, 'autoload.psr-4') as $namespace => $path) {
