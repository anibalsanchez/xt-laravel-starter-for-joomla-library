...
use Extly\Illuminate\Contracts\Http\Kernel as HttpKernel;
...
trait MakesHttpRequests
{
    ...
    {
        return XT_collect(array_merge($this->defaultHeaders, $headers))->mapWithKeys(function ($value, $name) {
    ...
    protected function prepareCookiesForRequest()
    {
        ...
        return XT_collect($this->defaultCookies)->map(function ($value, $key) {
            return XT_encrypt(CookieValuePrefix::create($key, XT_app('encrypter')->getKey()).$value, false);
