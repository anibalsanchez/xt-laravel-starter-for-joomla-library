...
use Extly\Illuminate\Foundation\Support\Providers\EventServiceProvider;
...
class EventListCommand extends Command
{
    ...
    protected function getEvents()
    {
        ...
        return XT_collect($events)->map(function ($listeners, $event) {
    ...
    protected function filterEvents(array $events)
    {
        ...
        return XT_collect($events)->filter(function ($listeners, $event) use ($eventName) {
