...
use Extly\Illuminate\Foundation\Events\VendorTagPublished;
...
use Extly\League\Flysystem\MountManager;
...
class VendorPublishCommand extends Command
{
    ...
    {
        $from = str_replace(XT_base_path(), '', realpath($from));

        $to = str_replace(XT_base_path(), '', realpath($to));
