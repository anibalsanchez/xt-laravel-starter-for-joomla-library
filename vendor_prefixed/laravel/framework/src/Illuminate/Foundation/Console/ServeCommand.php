...
class ServeCommand extends Command
{
    ...
    public function handle()
    {
        ...
        $environmentLastModified = $hasEnvironment
                            ...
                            : XT_now()->addDays(30)->getTimestamp();
    ...
    {
        $process = new Process($this->serverCommand(), null, XT_collect($_ENV)->mapWithKeys(function ($value, $key) use ($hasEnvironment) {
