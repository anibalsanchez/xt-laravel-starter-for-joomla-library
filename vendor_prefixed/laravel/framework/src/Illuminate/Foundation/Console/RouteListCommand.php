...
class RouteListCommand extends Command
{
    ...
    {
        $routes = XT_collect($this->router->getRoutes())->map(function ($route) {
    ...
    {
        return XT_collect($this->router->gatherRouteMiddleware($route))->map(function ($middleware) {
