...
class ComponentAttributeBag implements ArrayAccess, Htmlable, IteratorAggregate
{
    ...
    {
        return $this->getIterator()->current() ?? XT_value($default);
    }
    ...
    {
        return $this->attributes[$key] ?? XT_value($default);
    }
    ...
    {
        return new static(XT_collect($this->attributes)->filter($callback)->all());
    }
    ...
    public function merge(array $attributeDefaults = [], $escape = true)
    {
        ...
        [$appendableAttributes, $nonAppendableAttributes] = XT_collect($this->attributes)
