...
use Extly\Illuminate\Contracts\View\Factory as FactoryContract;
...
class Factory implements FactoryContract
{
    ...
    public function file($path, $data = [], $mergeData = [])
    {
        ...
        return XT_tap($this->viewInstance($path, $path, $data), function ($view) {
    ...
    public function make($view, $data = [], $mergeData = [])
    {
        ...
        return XT_tap($this->viewInstance($view, $path, $data), function ($view) {
            $this->callCreator($view);
        });
    }
