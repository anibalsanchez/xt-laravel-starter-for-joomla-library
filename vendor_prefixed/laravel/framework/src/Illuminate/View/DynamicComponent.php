...
use Extly\Illuminate\View\Compilers\ComponentTagCompiler;
...
EOF;
    ...
    protected function compileProps(array $bindings)
    {
        ...
        return '@props('.'[\''.implode('\',\'', XT_collect($bindings)->map(function ($dataKey) {
    ...
    {
        return XT_collect($bindings)->map(function ($key) {
    ...
    {
        return XT_collect($slots)->map(function ($slot, $name) {
