...
use Extly\Illuminate\Contracts\View\View as ViewContract;
...
abstract class Component
{
    ...
    protected function extractPublicProperties()
    {
        ...
        if (! isset(static::$propertyCache[$class])) {
            ...
            static::$propertyCache[$class] = XT_collect($reflection->getProperties(ReflectionProperty::IS_PUBLIC))
    ...
    protected function extractPublicMethods()
    {
        ...
        if (! isset(static::$methodCache[$class])) {
            ...
            static::$methodCache[$class] = XT_collect($reflection->getMethods(ReflectionMethod::IS_PUBLIC))
