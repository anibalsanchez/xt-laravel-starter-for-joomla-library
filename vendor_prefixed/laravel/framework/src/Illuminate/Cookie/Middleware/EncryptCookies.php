...
namespace Extly\Illuminate\Cookie\Middleware;

use Closure;
use Extly\Illuminate\Contracts\Encryption\DecryptException;
use Extly\Illuminate\Contracts\Encryption\Encrypter as EncrypterContract;
    ...
    protected function encrypt(Response $response)
    {
        foreach ($response->headers->getCookies() as $cookie) {
            ...
            $response->headers->setCookie($this->duplicate(
                $cookie,
                $this->encrypter->encrypt(CookieValuePrefix::create($cookie->getName(), $this->encrypter->getKey()).$cookie->getValue(),
