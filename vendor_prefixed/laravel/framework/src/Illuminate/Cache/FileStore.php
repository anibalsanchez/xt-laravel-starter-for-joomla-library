...
use Extly\Illuminate\Contracts\Filesystem\LockTimeoutException;
use Extly\Illuminate\Filesystem\Filesystem;
use Extly\Illuminate\Filesystem\LockableFile;
...
class FileStore implements Store, LockProvider
{
    ...
    public function increment($key, $value = 1)
    {
        ...
        return XT_tap(((int) $raw['data']) + $value, function ($newValue) use ($key, $raw) {
