...
use Extly\Illuminate\Redis\Connections\PhpRedisClusterConnection;
use Extly\Illuminate\Redis\Connections\PhpRedisConnection;
use Extly\Illuminate\Support\Arr;
use Extly\Illuminate\Support\Facades\Redis as RedisFacade;
...
class PhpRedisConnector implements Connector
{
    ...
    {
        return XT_tap(new Redis, function ($client) use ($config) {
    ...
    protected function createRedisClusterInstance(array $servers, array $options)
    {
        ...
        return XT_tap(new RedisCluster(...$parameters), function ($client) use ($options) {
