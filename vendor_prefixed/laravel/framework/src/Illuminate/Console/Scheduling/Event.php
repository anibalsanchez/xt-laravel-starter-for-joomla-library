...
class Event
{
    ...
    protected function runCommandInForeground(Container $container)
    {
        ...
        $this->exitCode = Process::fromShellCommandline($this->buildCommand(), XT_base_path(), null, null, null)->run();
    ...
    protected function runCommandInBackground(Container $container)
    {
        ...
        Process::fromShellCommandline($this->buildCommand(), XT_base_path(), null, null, null)->run();
    }
    ...
    protected function ensureOutputIsBeingCaptured()
    {
        if (is_null($this->output) || $this->output == $this->getDefaultOutput()) {
            $this->sendOutputTo(XT_storage_path('logs/schedule-'.sha1($this->mutexName()).'.log'));
        }
    }
