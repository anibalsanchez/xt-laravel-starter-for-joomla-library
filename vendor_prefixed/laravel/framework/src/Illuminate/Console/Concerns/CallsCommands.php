...
use Extly\Symfony\Component\Console\Output\NullOutput;
...
trait CallsCommands
{
    ...
    {
        return XT_tap(new ArrayInput(array_merge($this->context(), $arguments)), function ($input) {
    ...
    {
        return XT_collect($this->option())->only([
            'ansi',
            'no-ansi',
            'no-interaction',
            'quiet',
