...
namespace Extly\Illuminate\Http\Resources\Json;
...
class JsonResource implements ArrayAccess, JsonSerializable, Responsable, UrlRoutable
{
    ...
    {
        return XT_tap(new AnonymousResourceCollection($resource, static::class), function ($collection) {
    ...
    {
        $data = $this->toArray(
            $request = $request ?: Container::getInstance()->make('XT_request')
        );
    ...
    public function response($request = null)
    {
        return $this->toResponse(
            $request ?: Container::getInstance()->make('XT_request')
        );
    }
