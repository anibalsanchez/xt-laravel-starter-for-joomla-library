...
namespace Extly\Illuminate\Http\Concerns;
...
trait InteractsWithInput
{
    ...
    {
        return XT_data_get($this->getInputSource()->all() + $this->query->all(), $key, $default
        );
    }
    ...
    {
        return XT_collect($this->input($key));
    }
    ...
    public function only($keys)
    {
        ...
        foreach (is_array($keys) ? $keys : func_get_args() as $key) {
            $value = XT_data_get($input, $key, $placeholder);
    ...
    {
        return $this->retrieveItem('XT_request', $key, $default);
    }
    ...
    {
        return XT_data_get($this->allFiles(), $key, $default);
    }
