...
class Factory
{
    ...
    {
        return XT_tap($this->sequence(), function ($sequence) use ($url) {
    ...
    public function recorded($callback = null)
    {
        ...
        return XT_collect($this->recorded)->filter(function ($pair) use ($callback) {
    ...
    public function __call($method, $parameters)
    {
        ...
        return XT_tap($this->newPendingRequest(), function ($request) {
