...
use Exception;
use Extly\Illuminate\Contracts\Auth\Access\Gate as GateContract;
...
class Gate implements GateContract
{
    ...
    {
        return XT_collect($abilities)->every(function ($ability) use ($arguments) {
    ...
    {
        return XT_collect($abilities)->contains(function ($ability) use ($arguments) {
            return $this->check($ability, $arguments);
        });
    }
    ...
    public function raw($ability, $arguments = [])
    {
        ...
        return XT_tap($this->callAfterCallbacks(
    ...
    protected function guessPolicyName($class)
    {
        ...
        return Arr::wrap(Collection::times(count($classDirnameSegments), function ($index) use ($class, $classDirnameSegments) {
            ...
            return $classDirname.'\\Policies\\'.XT_class_basename($class).'Policy';
        })->reverse()->values()->first(function ($class) {
            return class_exists($class);
        }) ?: [$classDirname.'\\Policies\\'.XT_class_basename($class).'Policy']);
    }
