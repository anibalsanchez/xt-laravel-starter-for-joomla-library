...
use Extly\Illuminate\Contracts\Queue\ClearableQueue;
use Extly\Illuminate\Contracts\Queue\Queue as QueueContract;
use Extly\Illuminate\Database\Connection;
use Extly\Illuminate\Queue\Jobs\DatabaseJob;
use Extly\Illuminate\Queue\Jobs\DatabaseJobRecord;
...
class DatabaseQueue extends Queue implements QueueContract, ClearableQueue
{
    ...
    public function bulk($jobs, $data = '', $queue = null)
    {
        ...
        return $this->database->table($this->table)->insert(XT_collect((array) $jobs)->map(
