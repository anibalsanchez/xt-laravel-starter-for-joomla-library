...
use Extly\Illuminate\Contracts\Queue\Factory as QueueManager;
use Extly\Illuminate\Database\DetectsLostConnections;
use Extly\Illuminate\Queue\Events\JobExceptionOccurred;
use Extly\Illuminate\Queue\Events\JobProcessed;
use Extly\Illuminate\Queue\Events\JobProcessing;
use Extly\Illuminate\Queue\Events\Looping;
use Extly\Illuminate\Queue\Events\WorkerStopping;
...
class Worker
{
    ...
    protected function calculateBackoff($job, WorkerOptions $options)
    {
        ...
        return (int) ($backoff[$job->attempts() - 1] ?? XT_last($backoff));
    }
