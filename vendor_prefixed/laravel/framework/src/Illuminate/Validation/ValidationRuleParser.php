...
class ValidationRuleParser
{
    ...
    {
        $merge = XT_head($this->explodeRules([$rules]));
    ...
    {
        return XT_collect($rules)->mapWithKeys(function ($attributeRules, $attribute) use ($data) {
            ...
            return [$attribute => XT_collect($attributeRules)->map(function ($rule) use ($data) {
