...
namespace Extly\Illuminate\Database\Schema;

use BadMethodCallException;
use Closure;
use Extly\Illuminate\Database\Connection;
use Extly\Illuminate\Database\Query\Expression;
use Extly\Illuminate\Database\Schema\Grammars\Grammar;
use Extly\Illuminate\Database\SQLiteConnection;
...
class Blueprint
{
    ...
    {
        return XT_collect($this->commands)->filter(function ($command) use ($names) {
    ...
    {
        return XT_collect($this->commands)->contains(function ($command) {
    ...
    {
        return ! is_null(XT_collect($this->getAddedColumns())->first(function ($column) {
    ...
    public function autoIncrementingStartingValues()
    {
        ...
        return XT_collect($this->getAddedColumns())->mapWithKeys(function ($column) {
            return $column->autoIncrement === true
