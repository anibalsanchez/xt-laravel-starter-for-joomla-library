...
namespace Extly\Illuminate\Database\Console\Migrations;

use Extly\Illuminate\Console\ConfirmableTrait;
use Extly\Illuminate\Contracts\Events\Dispatcher;
use Extly\Illuminate\Database\Events\SchemaLoaded;
use Extly\Illuminate\Database\Migrations\Migrator;
use Extly\Illuminate\Database\SqlServerConnection;
...
class MigrateCommand extends BaseCommand
{
    ...
    protected function schemaPath($connection)
    {
        ...
        if (file_exists($path = XT_database_path('schema/'.$connection->getName().'-schema.dump'))) {
            return $path;
        }

        return XT_database_path('schema/'.$connection->getName().'-schema.sql');
    }
}
