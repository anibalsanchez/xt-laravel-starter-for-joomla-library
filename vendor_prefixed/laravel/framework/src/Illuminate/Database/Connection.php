...
use Extly\Doctrine\DBAL\Connection as DoctrineConnection;
use Exception;
use Extly\Illuminate\Contracts\Events\Dispatcher;
use Extly\Illuminate\Database\Events\QueryExecuted;
use Extly\Illuminate\Database\Events\StatementPrepared;
use Extly\Illuminate\Database\Events\TransactionBeginning;
use Extly\Illuminate\Database\Events\TransactionCommitted;
use Extly\Illuminate\Database\Events\TransactionRolledBack;
use Extly\Illuminate\Database\Query\Builder as QueryBuilder;
use Extly\Illuminate\Database\Query\Expression;
use Extly\Illuminate\Database\Query\Grammars\Grammar as QueryGrammar;
use Extly\Illuminate\Database\Query\Processors\Processor;
use Extly\Illuminate\Database\Schema\Builder as SchemaBuilder;
...
class Connection implements ConnectionInterface
{
    ...
    {
        return class_exists('Extly\Doctrine\DBAL\Connection');
    }
