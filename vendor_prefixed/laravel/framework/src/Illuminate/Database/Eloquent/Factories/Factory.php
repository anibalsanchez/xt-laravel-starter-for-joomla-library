...
abstract class Factory
{
    ...
    public function create($attributes = [], ?Model $parent = null)
    {
        ...
        if ($results instanceof Model) {
            $this->store(XT_collect([$results]));

            $this->callAfterCreating(XT_collect([$results]), $parent);
        } else {
            $this->store($results);
    ...
    public function make($attributes = [], ?Model $parent = null)
    {
        ...
        if ($this->count === null) {
            return XT_tap($this->makeInstance($parent), function ($instance) {
                $this->callAfterMaking(XT_collect([$instance]));
            });
        }
    ...
    protected function makeInstance(?Model $parent)
    {
        return Model::unguarded(function () use ($parent) {
            return XT_tap($this->newModel($this->getExpandedAttributes($parent)), function ($instance) {
                if (isset($this->connection)) {
    ...
    {
        return XT_collect($definition)->map(function ($attribute, $key) use (&$definition) {
    ...
    {
        $guess = Str::camel(Str::plural(XT_class_basename($related)));
    ...
    public function hasAttached($factory, $pivot = [], $relationship = null)
    {
        return $this->newInstance([
            'has' => $this->has->concat([new BelongsToManyRelationship(
                $factory,
                $pivot,
                $relationship ?: Str::camel(Str::plural(XT_class_basename($factory instanceof Factory
                        ? $factory->modelName()
    ...
    public function for($factory, $relationship = null)
    {
        return $this->newInstance(['for' => $this->for->concat([new BelongsToRelationship(
            $factory,
            $relationship ?: Str::camel(XT_class_basename($factory instanceof Factory ? $factory->modelName() : $factory
            ))
        )])]);
    }
    ...
    public function modelName()
    {
        $resolver = static::$modelNameResolver ?: function (self $factory) {
            $factoryBasename = Str::replaceLast('Factory', '', XT_class_basename($factory));
