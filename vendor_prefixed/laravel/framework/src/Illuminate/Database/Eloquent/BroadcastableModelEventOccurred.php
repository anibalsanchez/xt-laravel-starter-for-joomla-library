...
use Extly\Illuminate\Broadcasting\InteractsWithSockets;
use Extly\Illuminate\Broadcasting\PrivateChannel;
...
class BroadcastableModelEventOccurred implements ShouldBroadcast
{
    ...
    public function broadcastOn()
    {
        ...
        return XT_collect($channels)->map(function ($channel) {
    ...
    {
        $default = XT_class_basename($this->model).ucfirst($this->event);
