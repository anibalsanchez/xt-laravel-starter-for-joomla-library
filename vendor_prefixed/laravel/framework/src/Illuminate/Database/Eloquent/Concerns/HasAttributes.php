...
use Extly\Carbon\CarbonImmutable;
use Extly\Carbon\CarbonInterface;
use DateTimeInterface;
use Extly\Illuminate\Contracts\Database\Eloquent\Castable;
use Extly\Illuminate\Contracts\Database\Eloquent\CastsInboundAttributes;
use Extly\Illuminate\Contracts\Support\Arrayable;
use Extly\Illuminate\Database\Eloquent\Casts\AsArrayObject;
use Extly\Illuminate\Database\Eloquent\Casts\AsCollection;
use Extly\Illuminate\Database\Eloquent\InvalidCastException;
use Extly\Illuminate\Database\Eloquent\JsonEncodingException;
use Extly\Illuminate\Database\Eloquent\Relations\Relation;
use Extly\Illuminate\Database\LazyLoadingViolationException;
...
trait HasAttributes
{
    ...
    protected function getRelationshipFromMethod($method)
    {
        ...
        return XT_tap($relation->getResults(), function ($results) use ($method) {
    ...
    {
        return XT_tap($this->getArrayAttributeByKey($key), function (&$array) use ($path, $value) {
    ...
    protected function getOriginalWithoutRewindingModel($key = null, $default = null)
    {
        ...
        return XT_collect($this->original)->mapWithKeys(function ($value, $key) {
    ...
    {
        static::$mutatorCache[$class] = XT_collect(static::getMutatorMethods($class))->map(function ($match) {
