...
trait Prunable
{
    ...
    public function pruneAll(int $chunkSize = 1000)
    {
        ...
        $this->prunable()
            ->when(in_array(SoftDeletes::class, XT_class_uses_recursive(get_class($this))), function ($query) {
                $query->withTrashed();
    ...
    public function prune()
    {
        ...
        return in_array(SoftDeletes::class, XT_class_uses_recursive(get_class($this)))
                ? $this->forceDelete()
                : $this->delete();
    }
