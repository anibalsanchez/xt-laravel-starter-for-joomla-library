...
namespace Extly\Illuminate\Database\Eloquent\Relations\Concerns;
...
trait InteractsWithPivotTable
{
    ...
    {
        return $this->sync(XT_collect($this->parseIds($ids))->mapWithKeys(function ($id) use ($values) {
            return [$id => $values];
        }), $detaching);
    }
    ...
    {
        return XT_collect($records)->mapWithKeys(function ($attributes, $id) {
