...
use Extly\Illuminate\Database\Eloquent\Relations\Concerns\InteractsWithDictionary;
use Extly\Illuminate\Database\Eloquent\Relations\Concerns\InteractsWithPivotTable;
...
class BelongsToMany extends Relation
{
    ...
    protected function resolveTableName($table)
    {
        ...
        if (in_array(AsPivot::class, XT_class_uses_recursive($model))) {
            $this->using($table);
        }
    ...
    protected function aliasedPivotColumns()
    {
        ...
        return XT_collect(array_merge($defaults, $this->pivotColumns))->map(function ($column) {
    ...
    public function paginate($perPage = null, $columns = ['*'], $pageName = 'page', $page = null)
    {
        ...
        return XT_tap($this->query->paginate($perPage, $columns, $pageName, $page), function ($paginator) {
    ...
    public function simplePaginate($perPage = null, $columns = ['*'], $pageName = 'page', $page = null)
    {
        ...
        return XT_tap($this->query->simplePaginate($perPage, $columns, $pageName, $page), function ($paginator) {
            $this->hydratePivotRelation($paginator->items());
        });
    }
    ...
    public function cursorPaginate($perPage = null, $columns = ['*'], $cursorName = 'cursor', $cursor = null)
    {
        ...
        return XT_tap($this->query->cursorPaginate($perPage, $columns, $cursorName, $cursor), function ($paginator) {
            $this->hydratePivotRelation($paginator->items());
        });
    }
    ...
    {
        return Str::camel(Str::pluralStudly(XT_class_basename($this->getParent())));
    }
