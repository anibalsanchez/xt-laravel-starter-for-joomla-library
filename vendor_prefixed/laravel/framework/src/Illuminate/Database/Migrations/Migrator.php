...
use Extly\Illuminate\Database\Events\MigrationsEnded;
use Extly\Illuminate\Database\Events\MigrationsStarted;
use Extly\Illuminate\Database\Events\MigrationStarted;
use Extly\Illuminate\Database\Events\NoPendingMigrations;
...
class Migrator
{
    ...
    protected function resetMigrations(array $migrations, array $paths, $pretend = false)
    {
        ...
        $migrations = XT_collect($migrations)->map(function ($m) {
    ...
    public function usingConnection($name, callable $callback)
    {
        ...
        return XT_tap($callback(), function () use ($previousConnection) {
