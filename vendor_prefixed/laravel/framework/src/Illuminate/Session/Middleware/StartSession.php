...
use Extly\Illuminate\Session\SessionManager;
...
class StartSession
{
    ...
    {
        return XT_tap($session, function ($session) use ($request) {
    ...
    {
        return XT_tap($this->manager->driver(), function ($session) use ($request) {
