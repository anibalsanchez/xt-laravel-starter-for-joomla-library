...
use Extly\Illuminate\Contracts\Auth\Guard;
...
class DatabaseSessionHandler implements ExistenceAwareInterface, SessionHandlerInterface
{
    ...
    protected function getDefaultPayload($data)
    {
        ...
        return XT_tap($payload, function (&$payload) {
    ...
    {
        if ($this->container->bound('XT_request')) {
    ...
    {
        return $this->container->make('XT_request')->ip();
    }
    ...
    {
        return substr((string) $this->container->make('XT_request')->header('User-Agent'), 0, 500);
    }
