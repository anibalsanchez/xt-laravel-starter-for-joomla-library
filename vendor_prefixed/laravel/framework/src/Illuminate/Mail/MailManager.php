...
use Extly\Illuminate\Contracts\Mail\Factory as FactoryContract;
use Extly\Illuminate\Log\LogManager;
use Extly\Illuminate\Mail\Transport\ArrayTransport;
use Extly\Illuminate\Mail\Transport\LogTransport;
use Extly\Illuminate\Mail\Transport\MailgunTransport;
use Extly\Illuminate\Mail\Transport\SesTransport;
...
class MailManager implements FactoryContract
{
    ...
    protected function createPostmarkTransport(array $config)
    {
        ...
        return XT_tap(new PostmarkTransport(
