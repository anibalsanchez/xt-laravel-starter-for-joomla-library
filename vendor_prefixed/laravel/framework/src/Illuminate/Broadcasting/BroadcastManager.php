...
use Ably\AblyRest;
use Closure;
use Extly\Illuminate\Broadcasting\Broadcasters\AblyBroadcaster;
use Extly\Illuminate\Broadcasting\Broadcasters\LogBroadcaster;
use Extly\Illuminate\Broadcasting\Broadcasters\NullBroadcaster;
use Extly\Illuminate\Broadcasting\Broadcasters\PusherBroadcaster;
use Extly\Illuminate\Broadcasting\Broadcasters\RedisBroadcaster;
use Extly\Illuminate\Contracts\Broadcasting\Factory as FactoryContract;
use Extly\Illuminate\Contracts\Broadcasting\ShouldBroadcastNow;
...
class BroadcastManager implements FactoryContract
{
    ...
    public function routes(array $attributes = null)
    {
        ...
        $this->app['router']->group($attributes, function ($router) {
            ...
            )->withoutMiddleware([\Extly\Illuminate\Foundation\Http\Middleware\VerifyCsrfToken::class]);
        });
    }
    ...
    {
        if (! $request && ! $this->app->bound('XT_request')) {
            return;
        }

        $request = $request ?: $this->app['XT_request'];
