...
use Closure;
use Exception;
use Extly\Illuminate\Contracts\Notifications\Dispatcher as NotificationDispatcher;
use Extly\Illuminate\Contracts\Notifications\Factory as NotificationFactory;
...
class NotificationFake implements NotificationDispatcher, NotificationFactory
{
    ...
    {
        $actualCount = XT_collect($this->notifications)
            ->flatten(1)
    ...
    public function sent($notifiable, $notification, $callback = null)
    {
        ...
        $notifications = XT_collect($this->notificationsFor($notifiable, $notification));
    ...
    public function sendNow($notifiables, $notification, array $channels = null)
    {
        ...
        foreach ($notifiables as $notifiable) {
            ...
            $this->notifications[get_class($notifiable)][$notifiable->getKey()][get_class($notification)][] = [
                ...
                'locale' => $notification->locale ?? $this->locale ?? XT_value(function () use ($notifiable) {
