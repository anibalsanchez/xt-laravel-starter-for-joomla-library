...
use Closure;
use Extly\Illuminate\Contracts\Queue\Queue;
use Extly\Illuminate\Queue\QueueManager;
...
class QueueFake extends QueueManager implements Queue
{
    ...
    public function pushed($job, $callback = null)
    {
        ...
        return XT_collect($this->jobs[$job])->filter(function ($data) use ($callback) {
    ...
    {
        return XT_collect($this->jobs)->flatten(1)->filter(function ($job) use ($queue) {
