...
if (! function_exists('XT_retry')) {
     ...
     * @throws \Exception
     */
    function XT_retry($times, callable $callback, $sleep = 0, $when = null)
    {
        $attempts = 0;
...
if (! function_exists('XT_throw_if')) {
     ...
     * @throws \Throwable
     */
    function XT_throw_if($condition, $exception, ...$parameters)
    {
        if ($condition) {
...
if (! function_exists('XT_throw_unless')) {
     ...
     * @throws \Throwable
     */
    function XT_throw_unless($condition, $exception, ...$parameters)
    {
        if (! $condition) {
            throw (is_string($exception) ? new $exception(...$parameters) : $exception);
        }
