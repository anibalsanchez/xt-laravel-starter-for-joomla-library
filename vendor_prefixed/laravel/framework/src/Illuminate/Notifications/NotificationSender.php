...
use Extly\Illuminate\Database\Eloquent\Collection as ModelCollection;
use Extly\Illuminate\Database\Eloquent\Model;
use Extly\Illuminate\Notifications\Events\NotificationSending;
use Extly\Illuminate\Notifications\Events\NotificationSent;
...
class NotificationSender
{
    ...
    {
        return $notification->locale ?? $this->locale ?? XT_value(function () use ($notifiable) {
